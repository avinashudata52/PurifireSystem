      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><b>Sale Details</b></h3>
              </div>
                <div class="card-body">
                   ...
                   <table width="100%" border="1" cellpadding="5">
                        ...
                        <tbody>
                            ...
                            $qq="SELECT a.bill_no,a.date,a.edt,b.qty,b.rate,c.company_nm FROM `sale_entry` AS a
								LEFT JOIN `sale_entry_info` AS b ON a.id=b.lastId
								LEFT JOIN `party_details` AS c ON a.party_id=c.id
								WHERE b.item_nm='$vId'";
							$ss=$conn->prepare($qq);
							$ss->execute();
							$cnt=1;
