...
<script>
	function getdetails()
	{
		...
		//alert(partynm);	
		var scriptUrl ='get_sale_partydetails.php?sID='+partynm;
		//alert(scriptUrl);
...
function AddRow(tableID)
	{
				...
				else
				{
					...
					var scripturl='getitemdetails.php?hsnno='+item_name;
					$.ajax({url:scripturl,success:function(res)
					{
					//alert(res);
					var result=res.split('@')
					
					var hsn_code=result[0];
					var p_qty=result[1];
					var p_rate=result[2];
					...
					element5.id="p_qty"+rowCount;
					element5.name="p_qty[]";	
					element5.value=p_qty;
					element5.readOnly="true";		
					cell5.appendChild(element5);
					
					var element51 = document.createElement("label");
					element51.innerHTML=p_qty;		
					...
					element7.id="p_rate"+rowCount;
					element7.name="p_rate[]";	
					element7.value=p_rate;
					//element4.readOnly="true";			
					cell7.appendChild(element7);
					element7.style.width="100%";
					
					var element71 = document.createElement("label");
					element71.innerHTML=p_rate;		
					...
					element8.type="text";
					element8.id="i_total"+rowCount;
					element8.name="i_total[]";	
					element8.value=0;
...
function RowRemove()
{
 ...
 //chkboxx,countt,hsn_code,item_name,p_qty,i_qty,p_rate,i_total
  
   var i, n, ch, sr, hc, i_nm, i_pqt, i_qt, i_prt, i_tot;
  ...
  for (i = 1; i <= len; i++) 
  {
    ...
    i_pqt = document.getElementById("p_qty" + i);
    i_qt = document.getElementById("i_qty" + i);
	i_prt = document.getElementById("p_rate" + i);
	i_tot = document.getElementById("i_total" + i);
	//alert(sr);
	
	
    if (ch && sr && hc && i_nm && i_pqt && i_qt && i_prt && i_tot) {
      //alert(ch.checked);
	  if (ch.checked)
	   { 
        tbl.deleteRow(i);
...
function getcal()
{
	...
	{
		var a= parseFloat(document.getElementById('p_rate'+i).value);
		var aa=parseFloat(document.getElementById('p_qty'+i).value);
		var b= parseFloat(document.getElementById('i_qty'+i).value);
	
		if(b > aa)//(20>10)
		{
			alert('Please Enter Qty less than Stock Qty...');
			document.getElementById('i_qty'+i).value=0;	
			document.getElementById('i_total'+i).value=0;
		}
		else
		{
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><b>Sale Entry</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              
              <form class="form-horizontal" action="sale_ins.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
					  ...
					  $qry="SELECT id,company_nm FROM party_details WHERE sts='0'";
					  $st=$conn->prepare($qry);
					  $st->execute();
                  ...
                  <div>
                  <label style="color:RED"><u>Sale Information</u></label>
                  </div>
                  
                  
               <?php 
			   include('lib/function.php');
			   $qry="SELECT MAX(ID) AS billno FROM sale_billno";
			   $st=$conn->prepare($qry);
			   $st->execute();
			   ...
			   ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="txtbillno" name="txtbillno" value="<?php echo $s_code;?>" readonly>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
					  ...
					  $qry="SELECT a.itemnm,a.id FROM item_master AS a
							LEFT JOIN stock_maintain AS b ON a.id=b.itemId WHERE b.qty!='0'";
					  echo $qry."<br>";
                  ...
                  <div class="table-responsive" style="margin-top:15px">
                    ...
                    <th style="padding:10px;color:#fff;text-align:center">Stock Qty</th>
