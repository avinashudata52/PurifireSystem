          ...
          <div class="card card-primary">
            ...
            <div class="table-responsive">
              <table id="example1" class="table table-bordered">
				...
				$qry="SELECT a.id,a.date,a.bill_no,a.grand_tot,a.payamt,a.balamt,b.company_nm,b.mobile,b.email FROM purchase_entry AS a 
					  LEFT JOIN purchase_party_details AS b ON a.party_id=b.id order by a.id desc";
				$st=$conn->prepare($qry);
				$st->execute();
				$cnt=1;
				while($row=$st->fetch(PDO::FETCH_ASSOC))
				{
					...
					$qqq="SELECT SUM(paid_amt) AS totalpaid FROM purchase_outstanding WHERE purchase_id='$id'";
					...
					echo '<td align="center" ><a href="javascript:sentemail('.$smail.')">Sent</a></td>';
					if($netamt == "0")
					{
