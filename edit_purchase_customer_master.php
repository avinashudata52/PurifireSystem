...
$qry="SELECT id,company_nm,mobile,adrs,email,gst_no,state,city_pin FROM purchase_party_details WHERE id='$eId'";
//echo $qry."<br>";
$st=$conn->prepare($qry);
$st->execute();
  ...
  <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="update_purchase_details.php" method="post">
              <input type="hidden" value="<?php echo $id?>" id="eId" name="eId">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Company Name :</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="txtconpanynm" name="txtconpanynm" value="<?php echo $company_nm;?>" placeholder="Company Name" required onBlur="ChangeCase(this)">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="txtaddress" name="txtaddress" placeholder="Address" value="<?php echo $adrs;?>" required onBlur="ChangeCase(this)">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="txtgst" name="txtgst" placeholder="GST / UIN No" value="<?php echo $gst_no;?>" required>
                    </div>
