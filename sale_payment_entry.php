...
{
	window.open("sale_receipt.php?pId="+id, "_blank" ,"toolbar=yes, scrollbars=yes, resizable=no, top=20, left=10, width=700, height=450");
}
</script>
</head>
<body >
...
$qry="SELECT a.date,b.grand_tot,a.paid_amt,a.bal_amt,b.bill_no,b.id,c.company_nm FROM sale_outstanding AS a 
  ...
  <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <form action="ins_sale_receipt.php" method="post">
                <div class="card-body">
                ...
                <div class="row">
                	...
                	<div class="col-md-5">
                    	<div class="row">
                            ...
                            <?php 
							include('lib/function.php');
							$q="SELECT MAX(id) AS RctNo FROM sale_outstanding";
							$s=$conn->prepare($q);
							$s->execute();
                        ...
                        <div class="row" style="margin-top:8px">
                            ...
                            <?php 
							include('lib/function.php');
							$qq="SELECT SUM(paid_amt) AS totalpaid FROM sale_outstanding WHERE sale_id='$pId'";
							$ss=$conn->prepare($qq);
							$ss->execute();
                        ...
                        <div class="row" style="margin-top:8px">
                            ...
                            <?php 
							include('lib/function.php');
							$qqq="SELECT SUM(paid_amt) AS totalpaid FROM sale_outstanding WHERE sale_id='$pId'";
                        	...
                        	<?php 
							include('lib/function.php');
							$qqq1="SELECT SUM(paid_amt) AS totalpaid FROM sale_outstanding WHERE sale_id='$pId'";
                  ...
                  <button type="submit" class="btn btn-primary" id="btnsub" name="btnsub">Submit</button>
                    ...
                    <div class="col-md-7">
                    	<table width="100%" class="table table-bordered">
                            ...
                            <?php
                            include('lib/function.php');
							$query="SELECT id,receipt_no,`date`,paid_amt FROM sale_outstanding WHERE sale_id='$pId'";
