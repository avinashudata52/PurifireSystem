...
$qry="UPDATE purchase_party_details SET company_nm='$company_nm',mobile='$txtmob',adrs='$txtaddress',email='$txtemail',gst_no='$txtgst',state='$txtstate',city_pin='$txtcitypin' WHERE id='$eId'";
$st=$conn->prepare($qry);
$st->execute();
