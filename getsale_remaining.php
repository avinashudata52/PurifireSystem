...
$filename = "Sale Remainig Amount List".date('d.m.Y H:i:s a').".xls";
...
// Add some data
			...
			->setCellValue('H1', 'Total');
							...
							$qry1="SELECT a.id AS soID,a.sale_id,a.grand_tot,SUM(a.paid_amt) AS paid,b.id,b.bill_no,b.date,b.payamt,b.balamt,c.company_nm,c.mobile,c.email FROM sale_outstanding AS a
