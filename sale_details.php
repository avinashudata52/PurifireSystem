...
$qry="SELECT a.*,b.company_nm,b.mobile,b.adrs,b.email,b.gst_no,b.state,b.city_pin FROM `sale_entry` AS a
LEFT JOIN `party_details` AS b ON a.party_id=b.id
WHERE a.id='$vId'";
//echo $qry."<br>";
$st=$conn->prepare($qry);
$st->execute();
                  ...
                  <label style="color:RED"><u>Purchase Information</u></label>
                   ...
                   <table width="100%" border="1" cellpadding="5">
                        ...
                        <tbody>
                            ...
                            $vId=$_GET['vId'];
                            include('lib/function.php');
                            $qq="SELECT a.*,b.itemnm FROM sale_entry_info AS a
                            ...
                            <td>
                                <table cellpadding="3">
                                    ...
                                    <!--<tr>
                                        ...
                                        <td><label> <?php  echo $pay_bill_amt;?></label></td>
                                    </tr>-->
                                    <tr>
