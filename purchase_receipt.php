...
include('lib/function.php');
	...
	$qry="SELECT a.paid_amt,a.bal_amt,a.receipt_no,a.date,c.company_nm FROM purchase_outstanding AS a
LEFT JOIN purchase_entry AS b ON a.purchase_id=b.id
LEFT JOIN purchase_party_details AS c ON b.party_id=c.id WHERE a.id='$id'";
//echo $qry."<br>";	
$st=$conn->prepare($qry);
$st->execute();
